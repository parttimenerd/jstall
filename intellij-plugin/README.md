...
![Build](https://github.com/parttimenerd/jstall/actions/workflows/ide-intellij-build.yml/badge.svg)
...
- From a release:
  ...
  Download the [latest release](https://github.com/parttimenerd/jstall/releases?q=intellij) and install it manually using
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>⚙️</kbd> > <kbd>Install plugin from disk...</kbd>

- Build from source:

  ```bash
  git clone https://github.com/parttimenerd/jstall.git
